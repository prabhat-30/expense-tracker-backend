...
public class SecurityConfig {
        ...
        http
                ...
                .oauth2Login(oauth2 -> oauth2
                        .successHandler((request, response, authentication) -> {
                            ...
                            String targetUrl = "https://expense-tracker-frontend-0502.vercel.app/login?token=" + token + "&role=USER";
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://expense-tracker-frontend-0502.vercel.app"));
